    ...
    <div class="container-fostrap">
        <div class="content">
            <div class="container">
                ...
                'current_page' => 'Lokasi Kantor Desa',
                ])
					...
					<div class="box-body">
						<div class="row mt-3 container">
							...
							<div class="mt-3 gap-2 d-flex justify-content-end p-0">
								<a href="/staf/info-desa/identitas-desa/kantor/edit" class="btn btn-primary">Ubah Lokasi Kantor Desa</a>
							</div>
						</div>
					</div>
				</div>
...
<script>
	...
	var officeMarker = L.marker([{{ $lat }}, {{ $lng }}]).addTo(map);
	officeMarker.bindPopup('Kantor Desa Malik').openPopup();
</script>
