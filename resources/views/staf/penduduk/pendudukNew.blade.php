        ...
        <div class="col-lg">
            <form action="/staf/kependudukan/penduduk/new-penduduk" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm @error('nik') is-invalid @enderror"
                            name="nik" value="{{ old('nik') }}" placeholder="1903051234567890" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm @error('no_kk') is-invalid @enderror"
                            name="no_kk" placeholder="NO. KK" value="{{ old('no_kk') }}" required>
                ...
                <div class="form-group row">
					...
					<div class="col-sm-9">
						<select class="form-select form-select-sm" id="grup-input" name="id_hubungan_kk" required>
							<option value="">-- Pilih --</option>
							@foreach ($hubungan_kk as $item)
								<option value="{{ $loop->iteration }}" {{ old('id_hubungan_kk') == $loop->iteration ? 'selected' : '' }}>
									{{ $item->nama }}
								</option>
							@endforeach
						</select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select class="form-select form-select-sm pekerjaan_input" id="grup-input"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" name="nik_ayah"
                            placeholder="1903051234567890" value="{{ old('nik_ayah') }}" required>
                        @error('nik_ayah')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" name="nik_ibu"
                            placeholder="1903051234567890" value="{{ old('nik_ibu') }}" required>
                        @error('nik_ibu')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
