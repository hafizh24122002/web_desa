...
<div class="row mt-3 container">
	<div class="col-lg">
		<form action="/staf/kesehatan/kia/edit-kia/{{ $kia->id }}" method="POST">
			@method('put')
			@csrf

			<div class="form-group row">
				<label for="no_kia" class="col-sm-3 col-form-label">Nomor KIA</label>
				<div class="col-sm-9">
					<input type="text"
						class="form-control form-control-sm"
						name="no_kia"
						placeholder="12345"
						value="{{ old('no_kia') ?? $kia->no_kia }}"
						required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9" style="position: relative; display: inline-block">
					<input type="text" 
						...
						value="{{ old('nama_ibu') ?? $kia->ibu->nik.' - '.$kia->ibu->nama }}"
						autocomplete="off"
						required>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9" style="position: relative; display: inline-block">
					<input type="text" 
						...
						value="{{ old('nama_anak') ?? ($kia->anak ? $kia->anak->nik.' - '.$kia->anak->nama : '') }}"
						autocomplete="off"
						>
			...
			<div class="d-sm-flex justify-content-md-end">
				<button class="btn btn-primary mt-2 mb-4 px-3 py-1">Ubah Data KIA</button>
			</div>
		</form>
	</div>
</div>
