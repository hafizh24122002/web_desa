...
<div class="row mt-3 container">
	<div class="col-lg">
		<form action="/staf/manajemen-web/agenda/new-agenda" method="POST" autocomplete="off" id="form">
			@csrf
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="date"
						class="form-control form-control-sm @error('tgl_agenda') is-invalid @enderror"
						id="tgl_agenda"
						name="tgl_agenda"
						value="{{ old('tgl_agenda') }}">
			...
			<div class="form-group row">
				<label for="status" class="col-sm-2 col-form-label">Status Agenda</label>
			...
			<div class="d-sm-flex justify-content-md-end">
				<button class="btn btn-primary mt-2 mb-4 px-3 py-1">Tambah Agenda Baru</button>
			</div>
		</form>
	</div>
</div>
...
<script>
	...
	var quill = new Quill('#editor', {
		...
		theme: 'snow',
		placeholder: 'Tulis deskripsi agenda anda disini',
	});
