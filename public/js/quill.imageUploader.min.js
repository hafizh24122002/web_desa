! function(e) {
    ...
    s.blotName = "imageBlot", s.className = "image-uploading", s.tagName = "span", r.a.register({
        "formats/imageBlot": s
    });
    var c = s,
        f = function() {
    ...
    var d = function() {
        function e(t, n) {
            ! function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), this.quill = t, this.options = n, this.range = null, this.placeholderDelta = null, "function" != typeof this.options.upload && console.warn("[Missing config] upload function that returns a promise is required");
            var i = this.quill.getModule("toolbar");
            i && i.addHandler("image", this.selectLocalImage.bind(this)), this.handleDrop = this.handleDrop.bind(this), this.handlePaste = this.handlePaste.bind(this), this.quill.root.addEventListener("drop", this.handleDrop, !1), this.quill.root.addEventListener("paste", this.handlePaste, !1)
        }
        return f(e, [{
            ...
            value: function(e) {
                ...
                if (e.dataTransfer && e.dataTransfer.files && e.dataTransfer.files.length) {
                    if (e.stopPropagation(), e.preventDefault(), document.caretRangeFromPoint) {
                    ...
                    setTimeout((function() {
                        t.quill.focus(), t.range = t.quill.getSelection(), t.readAndUploadFile(a)
                    }), 0)
                }
            }
        }, {
            ...
            value: function(e) {
                ...
                if (n && (n.items || n.files))
                    for (var i = n.items || n.files, r = /^image\/(jpe?g|gif|png|svg|webp)$/i, o = 0; o < i.length; o++) r.test(i[o].type) && function() {
                        ...
                        n && (t.quill.focus(), t.range = t.quill.getSelection(), e.preventDefault(), setTimeout((function() {
                            t.quill.focus(), t.range = t.quill.getSelection(), t.readAndUploadFile(n)
                        }), 0))
                    }()
            }
        }, {
            ...
            value: function(e) {
                ...
                this.quill.deleteText(t.index, n, "user"), this.quill.insertEmbed(t.index, "image", "" + e, "user"), this.quill.formatText(t.index, t.index+1, 'height', '400'), t.index++, this.quill.setSelection(t, "user")
            }
        }, {
            key: "calculatePlaceholderInsertLength",
            value: function() {
                return this.placeholderDelta.ops.reduce((function(e, t) {
                    return t.hasOwnProperty("insert") && e++, e
                }), 0)
            }
        }, {
