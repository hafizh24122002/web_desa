                            ...
                            @foreach ($dusun as $key => $data)
                                <tr class="align-middle text-center">
                                    ...
                                    <td class="d-flex gap-1 justify-content-center">
                                        ...
                                        <form action="/staf/info-desa/dusun/{{ $data->id }}"
                                            onsubmit="return confirm('Apakah anda yakin ingin menghapus dusun ini? Dusun yang dihapus tidak akan bisa dikembalikan!')"
                                            method="POST">
