			...
			<div class="row mt-3 container">
				<div class="col-lg">
					<form action="/staf/kesehatan/pemantauan/new-pemantauan-anak" method="POST">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<select class="form-select form-select-sm @error('id_kia') is-invalid @enderror" id="id_kia" name="id_kia">
									...
									@foreach ($kia as $item)
										<option value="{{ $item->id }}" {{ old('id_kia') == $item->id ? 'selected' : '' }}>{{ $item->no_kia.' - '.$item->anak->nama }}</option>
									@endforeach
								</select>
						...
						<div class="form-group row">
							<label for="umur" class="col-sm-3 col-form-label">Umur<span style="color:red">*</span></label>
							<div class="col-sm-9">
								<input type="number"
