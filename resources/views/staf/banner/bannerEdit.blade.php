...
<div class="mt-3 container">
	...
	<div class="col-lg">
		<form action="/staf/manajemen-web/banner/edit-banner/{{ $banner->no_urut }}" method="POST" autocomplete="off" id="form" enctype="multipart/form-data">
			@method('put')
			@csrf
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text"
						...
						maxlength="80"
						value="{{ old('deskripsi') ?? $banner->deskripsi }}">
